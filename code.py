...
BEGIN
    ...
    -- =========================================
    -- Date range = previous complete calendar month
    -- Run in June → May 1 to May 31
    -- Run in July → June 1 to June 30
    -- =========================================
    DECLARE @StartDT DATE = DATEADD(
        MONTH, DATEDIFF(MONTH, 0, GETDATE()) - 1, 0);

    DECLARE @EndDT   DATE = DATEADD(
        DAY, -1,
